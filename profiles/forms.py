...
class RoleChangeRequestForm(forms.ModelForm):
    ...
    to provide details about the charity they represent when requesting a role change.
    It includes fields for the charity's name, registration number, website, 
    and a description. A custom widget is used for the `charity_description` field 
    to provide a larger text area with 4 rows for input.
    """
    class Meta:
